    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          These projects represent my hands-on experience in building real-world applications using modern web technologies. Each project highlights my approach to problem-solving, from planning and development to testing and refinement. Through this work, I've explored different tools and frameworks, strengthened my technical foundation, and learned how to build practical, user-focused solutions.
        </p>
      </div>
